...
<script type="text/javascript">
        ...
        //Abaixo estamos adcionando os valores de cada botÃ£o ao parametro Num
        ...
        //Valores de exibiÃ§Ã£o quando apertado o botÃ£o igual
        function Operation(Op) {
            if (document.frm_calc.txt_01.value == ""){
                alert("O Campo esta vÃ¡zio digite um valor");
        ...
        //Atribuindo o ponto( . ) aos valores numÃ©ricos
        function Ponto() {
